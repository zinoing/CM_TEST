...
namespace ColorMemory.Data
{
    ...
    public class PlayerArtwork
    {
        ...
        public int TotalMoveCnt { get; set;}

        [Required]
        [Column(TypeName = "json")]
        public string Moves { get; set; } = JsonConvert.SerializeObject(
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PlayerArtwork>(entity =>
            {
                ...
                entity.HasOne(pa => pa.Artwork)
                      .WithMany() // 탐색 속성 없으므로 WithMany()만
                ...
                entity.Property(pa => pa.TotalMoveCnt).HasDefaultValue(0);
                entity.Property(pa => pa.Moves)
                      .IsRequired()
                      .HasColumnType("json");
            });
        }
